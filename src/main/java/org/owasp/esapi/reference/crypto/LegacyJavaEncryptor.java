 ...
 * @see org.owasp.esapi.reference.crypto.JavaEncryptor
 * @since 2.0
 */
public final class LegacyJavaEncryptor extends JavaEncryptor {
	 ...
	 * 
	 * @see org.owasp.esapi.reference.crypto.JavaEncryptor#encrypt(String)
	 * 
	 ...
	 * 
	 * @see org.owasp.esapi.reference.crypto.JavaEncryptor#decrypt(String)
	 * 
