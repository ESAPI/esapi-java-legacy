...
public class XMLEntityCodecTest extends TestCase
{
	...
	{
		StringBuffer sb = new StringBuffer("AB_YZ");
		String str;

		//for(char ch : UNENCODED_SET)
		for(Iterator i=UNENCODED_SET.iterator();i.hasNext();)
		{
	...
	{
		StringBuffer inSb = new StringBuffer("AB_YZ");
		StringBuffer outSb = new StringBuffer("AB&#x");
		String in;
		String expected;
		String result;
		...
		{
			char ch = (char)c;
			if(UNENCODED_SET.contains(PrimWrap.wrapChar(ch)))
				continue;
			inSb.setCharAt(2,ch);
			in = inSb.toString();
	...
	{
		StringBuffer expectedSb = new StringBuffer("AB_YZ");
		StringBuffer inSb = new StringBuffer("AB&#x");
		String in;
		String expected;
		String result;
	...
	{
		StringBuffer expectedSb = new StringBuffer("AB_YZ");
		StringBuffer inSb = new StringBuffer("AB&#");
		String in;
		String expected;
		String result;
		int inSbBaseLen = inSb.length();
