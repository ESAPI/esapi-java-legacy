...
public class PreparedString {
	...
	public static void main( String[] args ) {
		PreparedString ps1 = new PreparedString( "Test ? is ?", new HTMLEntityCodec() );
		ps1.set( 1, "[]<>;\"\'PreparedString" );
		ps1.set( 2, "cool" );
		System.out.println( ps1 );
		try {
			PreparedString ps2 = new PreparedString( "Test ? is ?", new HTMLEntityCodec() );
			ps2.set( 2, "cool" );
		...
		try {
			PreparedString ps3 = new PreparedString( "Test ? is ?", new HTMLEntityCodec() );
		...
		try {
			PreparedString ps4 = new PreparedString( "???", new HTMLEntityCodec() );
			ps4.set( 1, "1" );
			ps4.set( 2, "2" );
			ps4.set( 3, "3" );
		...
		try {
			PreparedString ps5 = new PreparedString( "??x", new HTMLEntityCodec() );
			ps5.set( 1, "1" );
			ps5.set( 2, "2" );
