 ...
 * <p>
 * A ConfigurationException is a RuntimeException because 1) configuration
 * properties can, for the most part, only be checked at run-time, and 2) we
 * want this to be an unchecked exception to make ESAPI easy to use and not
 * cluttered with catching a bunch of try/catch blocks.
 * </p>
 */
