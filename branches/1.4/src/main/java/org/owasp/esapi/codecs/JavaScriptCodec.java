...
public class JavaScriptCodec extends Codec {
	...
	public Character decodeCharacter( PushbackString input ) {
		...
		if (second == new Character('b') ) {
			return new Character((char)0x08);
		} else if (second == new Character('t') ) {
			return new Character((char)0x09);
		} else if (second == new Character('n') ) {
			return new Character((char)0x0a);
		} else if (second == new Character('v') ) {
			return new Character((char)0x0b);
		} else if (second == new Character('f') ) {
			return new Character((char)0x0c);
		} else if (second == new Character('r') ) {
			return new Character((char)0x0d);
		} else if (second == new Character('\"') ) {
